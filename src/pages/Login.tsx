      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border border-yellow-200 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-gray-900">Selamat Datang Kembali</CardTitle>
            <CardDescription className="text-gray-600">
              Masuk ke akun Skillswap kamu untuk mulai bertukar skill
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2">
                  <input type="checkbox" className="rounded text-yellow-600 border-yellow-300 focus:ring-yellow-500" />
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 space-y-2">
                <Button variant="outline" className="w-full border-yellow-200 text-gray-700 hover:bg-yellow-50">
